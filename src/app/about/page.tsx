  ...
  return (
    <SiteShell active="About Us">
      ...
      <section className="px-[clamp(24px,5vw,72px)] pb-10 pt-[clamp(40px,8vh,90px)]">
        <div className="mx-auto max-w-[1440px]">
          <Reveal>
            ...
            <h1 className="mt-3 max-w-4xl text-[clamp(32px,5vw,62px)] font-semibold uppercase leading-[1.08] tracking-[0.01em]">
      ...
      <section className="px-[clamp(24px,5vw,72px)] pb-[clamp(64px,12vh,140px)]">
        <Reveal>
          <div className="mx-auto flex max-w-[1440px] flex-col items-start gap-6 border border-white/12 bg-white/[0.02] p-[clamp(28px,5vw,64px)] md:flex-row md:items-center md:justify-between">
