  ...
  return (
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
      {logos.map((logo) => (
        <div
          key={logo.file}
          className="group flex flex-col overflow-hidden border border-black/10 bg-white transition-all duration-300 hover:border-black/25 hover:shadow-md"
        >
          ...
          <div className="border-t border-black/10 bg-[#fafafa] px-4 py-2.5 text-center text-[11px] uppercase tracking-[0.14em] text-black/55 transition-colors group-hover:text-[#0d0d0e]">
            {logo.name}
          </div>
        </div>
      ))}
