      ...
      <article className="px-[clamp(24px,5vw,72px)] pt-[clamp(28px,5vh,56px)]">
        <div className="mx-auto max-w-[1440px]">
            ...
            <Reveal delay={80}>
              <div className="flex flex-col">
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                  <h1 className="text-[clamp(34px,4.5vw,56px)] font-semibold uppercase leading-none tracking-[0.01em]">
                    {product.name}
                  </h1>
                  {product.isNew && (
                    <span className="border border-white/30 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.14em] text-white/80">
                      New launch
                    </span>
                  )}
                </div>
                ...
                <dl className="mt-8 grid grid-cols-2 gap-px overflow-hidden border border-white/10 bg-white/10 sm:grid-cols-4">
                  {[
                    ...
                    <div key={k} className="bg-[#0d0d0e] px-4 py-4">
          ...
          <Reveal className="mt-[clamp(48px,8vh,88px)]">
            <h2 className="text-xl font-semibold uppercase tracking-[0.03em]">Specifications</h2>
              ...
              <table className="w-full min-w-[560px] border-collapse text-left text-sm">
                ...
                <tbody>
                  {product.variants.map((v) => (
                    <tr
                      key={v.code + v.watt}
                      className="border-b border-white/5 text-white/75 transition-colors last:border-b-0 hover:bg-white/[0.03] hover:text-white"
                    >
